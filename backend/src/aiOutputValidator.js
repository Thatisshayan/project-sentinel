/**
 * Lightweight structural validation for AI-generated JSON outputs.
 * Returns { valid: true, data } or throws with a descriptive error.
 */

function validateAuditOutput(parsed) {
...
function validateSprintOutput(parsed) {
  if (!parsed || typeof parsed !== 'object') {
...
function validateBrainOutput(parsed) {
  if (!parsed || typeof parsed !== 'object') {
...
module.exports = { validateAuditOutput, validateSprintOutput, validateBrainOutput };
