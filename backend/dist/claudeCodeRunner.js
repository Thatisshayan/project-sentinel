...
const BUILD_TIMEOUT_MS = () => parseInt(process.env['DEBUG_TIMEOUT_MINUTES'] || process.env['AIDER_TIMEOUT_MINUTES'] || '30') * 60 * 1000;
...
async function runClaudeCodeForTask(repoPath, task, context) {
    ...
    return new Promise((resolve) => {
        ...
        logger_1.default.info({ taskNumber: task.task_number, title: task.title }, 'Claude Code task execution starting');
        let stdout = '';
        let stderr = '';
...
//# sourceMappingURL=claudeCodeRunner.js.map