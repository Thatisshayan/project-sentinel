...
async function initSelfAuditSchema() {
  ...
  `);
    logger_1.default.info('Self-audit schema initialised');
}
...
async function updateSelfAuditCycle(id, updates) {
    ...
    const r = await query(`UPDATE self_audit_cycles SET ${fields} WHERE id = $1 RETURNING *`, [id, ...values]);
...
//# sourceMappingURL=selfAuditDb.js.map